import{Memoirist as e}from"memoirist";import t from"eventemitter3";import{createTraceListener as r}from"./trace";import{ElysiaWS as s,websocket as i}from"./ws";import{isNotEmpty as o}from"./handler";import{composeHandler as n,composeGeneralHandler as a,composeErrorHandler as h}from"./compose";import{mergeHook as c,getSchemaValidator as d,getResponseSchemaValidator as f,mergeDeep as l,mergeCookie as p,checksum as u,mergeLifeCycle as m,filterGlobalHook as v,asGlobal as y}from"./utils";import{createDynamicErrorHandler as g,createDynamicHandler as b}from"./dynamic-handle";import{isProduction as k,ERROR_CODE as w,ValidationError as R}from"./error";import{t as E}from"./custom-types";/**
 * ### Elysia Server
 ...
 *     .listen(8080)
 * ```
 */export default class x{config;dependencies={};store={};decorators={};definitions={type:{},error:{}};schema={};event={start:[],request:[],parse:[],transform:[],beforeHandle:[],afterHandle:[],onResponse:[],trace:[],error:[],stop:[]};reporter=new t;server=null;getServer(){return this.server}validator=null;router=new e;routes=[];staticRouter={handlers:[],variables:"",map:{},all:""};dynamicRouter=new e;lazyLoadModules=[];path="";constructor(e){this.config={forceErrorEncapsulation:!1,prefix:"",aot:!0,strictPath:!1,scoped:!1,cookie:{},...e,seed:e?.seed===void 0?"":e?.seed}}add(e,t,r,s,{allowMeta:i=!1,skipPrefix:a=!1}={allowMeta:!1,skipPrefix:!1}){for(let h of("string"==typeof t&&(t=[t]),t)){if(h=""===h?h:47===h.charCodeAt(0)?h:`/${h}`,this.config.prefix&&!a&&(h=this.config.prefix+h),s?.type)switch(s.type){case"text":s.type="text/plain";break;case"json":s.type="application/json";break;case"formdata":s.type="multipart/form-data";break;case"urlencoded":s.type="application/x-www-form-urlencoded";break;case"arrayBuffer":s.type="application/octet-stream"}let t=this.definitions.type,l=d(s?.cookie??this.validator?.cookie,{dynamic:!this.config.aot,models:t,additionalProperties:!0});o(this.config.cookie??{})&&(l?// @ts-ignore
l.schema=p(// @ts-ignore
l.schema,this.config.cookie??{}):l=d(// @ts-ignore
E.Cookie({},this.config.cookie),{dynamic:!this.config.aot,models:t,additionalProperties:!0}));let u={body:d(s?.body??this.validator?.body,{dynamic:!this.config.aot,models:t}),headers:d(s?.headers??this.validator?.headers,{dynamic:!this.config.aot,models:t,additionalProperties:!0}),params:d(s?.params??this.validator?.params,{dynamic:!this.config.aot,models:t}),query:d(s?.query??this.validator?.query,{dynamic:!this.config.aot,models:t}),cookie:l,response:f(s?.response??this.validator?.response,{dynamic:!this.config.aot,models:t})},m=c(this.event,s),v=h.endsWith("/")?h.slice(0,h.length-1):h+"/";if(!1===this.config.aot){this.dynamicRouter.add(e,h,{validator:u,hooks:m,content:s?.type,handle:r}),!1===this.config.strictPath&&this.dynamicRouter.add(e,v,{validator:u,hooks:m,content:s?.type,handle:r}),this.routes.push({method:e,path:h,composed:null,handler:r,hooks:m});return}let y=n({path:h,method:e,hooks:m,validator:u,handler:r,handleError:this.handleError,onRequest:this.event.request,config:this.config,definitions:i?this.definitions.type:void 0,schema:i?this.schema:void 0,reporter:this.reporter});if(this.routes.push({method:e,path:h,composed:y,handler:r,hooks:m}),-1===h.indexOf(":")&&-1===h.indexOf("*")){let t=this.staticRouter.handlers.length;this.staticRouter.handlers.push(y),this.staticRouter.variables+=`const st${t} = staticRouter.handlers[${t}]
...
`,this.config.strictPath||(this.staticRouter.map[v]||(this.staticRouter.map[v]={code:""}),"ALL"===e?this.staticRouter.map[v].all=`default: return st${t}(ctx)
`:this.staticRouter.map[v].code+=`case '${e}': return st${t}(ctx)
`)}else this.router.add(e,h,y),this.config.strictPath||this.router.add(e,h.endsWith("/")?h.slice(0,h.length-1):h+"/",y)}}/**
...
this.definitions.error[t]=r;return this}/**
	 ...
	 *     })
	 * ```
	 */group(e,t,r){let s=new x({...this.config,prefix:""});s.store=this.store;let i="object"==typeof t,o=(i?r:t)(s);return this.decorators=l(this.decorators,s.decorators),o.event.request.length&&(this.event.request=[...this.event.request,...o.event.request]),o.event.onResponse.length&&(this.event.onResponse=[...this.event.onResponse,...o.event.onResponse]),this.model(o.definitions.type),Object.values(s.routes).forEach(({method:r,path:s,handler:n,hooks:a})=>{s=this.config.prefix+e+s,i?this.add(r,s,n,c(t,{...a,error:a.error?Array.isArray(a.error)?[...a.error,...o.event.error]:[a.error,...o.event.error]:o.event.error})):this.add(r,s,n,c(a,{error:o.event.error}),{skipPrefix:!0})}),this}/**
	 * ### guard
	 ...
	 *     .use(plugin)
	 * ```
	 */use(e){return e instanceof Promise?(this.lazyLoadModules.push(e.then(e=>"function"==typeof e?e(this):"function"==typeof e.default?e.default(this):this._use(e)).then(e=>e.compile())),this):this._use(e)}_use(e){if("function"==typeof e){let t=e(this);return t instanceof Promise?(this.lazyLoadModules.push(t.then(e=>e.compile())),this):t}let{name:t,seed:r}=e.config;e.getServer=()=>this.getServer();let s=e.config.scoped;if(s){if(t){t in this.dependencies||(this.dependencies[t]=[]);let e=void 0!==r?u(t+JSON.stringify(r)):0;if(this.dependencies[t].some(t=>e===t))return this;this.dependencies[t].push(e)}return e.model(this.definitions.type),e.error(this.definitions.error),e.onRequest(e=>{Object.assign(e,this.decorators),Object.assign(e.store,this.store)}),e.config.aot&&e.compile(),this.mount(e.fetch)}for(let{method:t,path:r,handler:s,hooks:i}of(this.decorate(e.decorators),this.state(e.store),this.model(e.definitions.type),this.error(e.definitions.error),Object.values(e.routes)))this.add(t,r,s,c(i,{error:e.event.error}));if(!s){if(t){t in this.dependencies||(this.dependencies[t]=[]);let s=void 0!==r?u(t+JSON.stringify(r)):0;if(this.dependencies[t].some(e=>s===e))return this;this.dependencies[t].push(s),this.event=m(this.event,v(e.event),s)}else this.event=m(this.event,v(e.event))}return this}mount(e,t){if("function"==typeof e||0===e.length||"/"===e){let r="function"==typeof e?e:t,s=async({request:e,path:t})=>r(new Request("http://a.cc"+t,e));return this.all("/",s,{type:"none"}),this.all("/*",s,{type:"none"}),this}let r=e.length,s=async({request:e,path:s})=>t(new Request("http://a.cc"+s.slice(r),e));return this.all(e,s,{type:"none"}),this.all(e+(e.endsWith("/")?"*":"/*"),s,{type:"none"}),this}/**
	 * ### get
...
e=>{// eslint-disable-next-line @typescript-eslint/no-unused-vars
let{set:r,path:h,qi:c,headers:d,query:f,params:l}=e;if(null===i&&(i=this.getServer()),!i?.upgrade(e.request,{headers:"function"==typeof t.upgrade?t.upgrade(e):t.upgrade,data:{validator:n,open(r){t.open?.(new s(r,e))},message:(r,i)=>{let n=a(i);if(o?.Check(n)===!1)return void r.send(new R("message",o,n).message);t.message?.(new s(r,e),n)},drain(r){t.drain?.(new s(r,e))},close(r,i,o){t.close?.(new s(r,e),i,o)}}}))return r.status=400,"Expected a websocket connection"},{beforeHandle:t.beforeHandle,transform:t.transform,headers:t.headers,params:t.params,query:t.query}),this}/**
	 * ### route
	 ...
	 *     .get('/', (({ counter }) => ++counter)
	 * ```
	 */state(e,t){switch(typeof e){case"object":return this.store=l(this.store,e),this;case"function":return this.store=e(this.store),this}return e in this.store||(this.store[e]=t),this}/**
	 * ### decorate
	 ...
	 *     .get('/', (({ getDate }) => getDate())
	 * ```
	 */decorate(e,t){switch(typeof e){case"object":return this.decorators=l(this.decorators,e),this;case"function":return this.decorators=e(this.decorators),this}return e in this.decorators||(this.decorators[e]=t),this}/**
